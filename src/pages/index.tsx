...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`TestFitness`}</title>

        <meta
          name="description"
          content="TestFitness: Elevate your gym experience. Book, cancel, and view schedules with ease. Keep track of your bookings and discover nearby fitness clubs. Your fitness journey streamlined."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1527933053326-89d1746b76b9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmaXRuZXNzJTIwY2x1YnxlbnwwfHx8fDE2OTUzNzA5OTh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@shotsbywolf?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Geert Pieters`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`TestFitness: Elevate your gym experience. Book, cancel, and view schedules with ease. Keep track of your bookings and discover nearby fitness clubs. Your fitness journey streamlined.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Gym Member" type="gym-member" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
