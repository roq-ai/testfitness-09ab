...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Class Addition.create': { roles: ['gym-member'], key: 'class_addition', tenantPath: [], userPath: [] },
  'Class Cancellation.delete': { roles: ['gym-member'], key: 'class_cancellation', tenantPath: [], userPath: [] },
  'Class Schedule Update.update': { roles: ['gym-member'], key: 'class_schedule_update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['gym-member'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['gym-member'];
